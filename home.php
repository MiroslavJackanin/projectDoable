    ...
    <main>
        <div class="container">
         ...
         <div class="col-sm-5">
                ...
                <form action="home.php" method="get" style="margin:0px 10px 10px 0px;">
                    <input style="margin: 0 10px 0 0" class="btn btn-outline-warning" type="date" name="date_by_user" onchange="getDate(this.value)" value=<?php echo $curentdate ?>>
            ...
            echo '<div class="progressbar" style="margin-top:100px">';
        ...
        <form id="delete-form" action="_inc/delete_item.php" method="get">
            <div class="card text-white bg-dark mb-3 form-content" style="min-width: 20rem; max-width: 30rem; min-height: 10rem;">
                <div class="card-header">
                        <div class="row justify-content-between delete-text" style="max-width: 436px; margin: 0;">Delete this task?</div>
                    </div>
